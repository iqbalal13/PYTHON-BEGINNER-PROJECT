...
def cone_perimeter(radius, slant_height, pi_option, unit):
    ...
    # Draw a line below the result
    print("-" * 40)

# Main loop with a fixed number of iterations
max_iterations = 3  # Set a reasonable number of iterations
iteration = 0
...
while iteration < max_iterations:
    ...
    radius_input = input(f"Enter the radius of the cone base (iteration {iteration}/{max_iterations}, type 'quit' to exit): ")
    ...
    # If all inputs are valid, perform some action (in this case, call the cone_perimeter function)
    else:
