...
class GameBot:
    ...
    def start_game(self):
        ...
        for outer_attempts in range(3):  # Limit the number of attempts to 3 for this example
            for inner_attempts in range(3):  # Limit the number of input attempts to 3 for this example
            ...
            if guess == self.secret_number:
                ...
                print(f"Wrong guess. The correct number is {self.secret_number}. Your score is reset to 0.")
                self.score = 0
