...
while lives > 0:
    ...
    if ball_position == paddle_position:
        ...
        # Nested if statements to check ball position relative to paddle
        if ball_position < paddle_position:
            print("Missed! Ball is to the left of the paddle.")
        else:
            print("Missed! Ball is to the right of the paddle.")
